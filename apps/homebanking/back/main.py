"""HOMEBANKING — Backend FastAPI · Banca Internet Scotiabank.
...
app = FastAPI(
    title="Banca Internet Scotiabank — Homebanking API",
    description="Portal del cliente de Banca Internet Scotiabank. Solo consultas y "
...
def raiz():
    return {
        "servicio": "Banca Internet Scotiabank — Homebanking API",
        "version": "1.0.0",
        "estado": "ok",
        "docs": "/docs",
