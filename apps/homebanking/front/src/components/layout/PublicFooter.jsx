    ...
    <footer className="lp-footer" id="footer">
      <div className="lp-footer-inner">
        <div className="lp-footer-brand">
          ...
          <p>Banca por Internet 100% en línea, segura y a tu alcance. Proyecto académico — Sistema Core Bancario + Homebanking.</p>
        ...
        <div className="lp-footer-col">
          ...
          <ul className="lp-contact">
            ...
            <li><Mail size={15} /> contacto@scotiabank.com.pe</li>
            <li><MapPin size={15} /> Av. Dionisio Derteano 102, Lima</li>
          </ul>
        </div>
      </div>
      ...
      <div className="lp-footer-legal">
        © {2026} Scotiabank — Banca por Internet. Demo educativo. Supervisado por la SBS.
      </div>
    </footer>
  )
}
